...
const CHECKLIST_SCHEMA = {
	...
	"Electrical Systems": [
		{
			...
			allow_photo: false,
			allow_multi_photo: false,
			explanation_departing:
				"Check that the shore power connection is active and charging the batteries.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Inspect the cable for any fraying, burns, or loose connections at both ends.",
			explanation_returning:
				"Coil the shore power cable neatly if not in use, or check connections if plugged in.",
		},
		{
			id: "generator",
			label: "Generator",
			...
			allow_multi_photo: false,
			explanation_departing:
				"Start the generator and verify it provides stable AC power to the vessel.",
			explanation_returning:
				"Ensure the generator is turned off and cooling water seacock is closed if required.",
		},
		{
			id: "battery",
			label: "Battery",
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check battery voltage levels and ensure terminals are clean and tight.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Verify that GFCI and standard outlets have power when on shore power or inverter.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Test the inverter by powering a small AC device while disconnected from shore power.",
	...
	Lights: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Verify that red (port), green (starboard), and white (stern) lights are functional for night operations.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the forward-facing white light on the mast used when under engine power.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the spreader or mast-mounted lights used for illuminating the deck at night.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Ensure all interior lighting is functional, including red 'night' lights if equipped.",
	...
	Comms: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Ensure GPS, Chartplotter, and Depth Sounder power on and acquire a signal.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Perform a radio check on VHF Channel 16/9 to ensure transmission and reception are clear.",
	...
	Paperwork: [
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Verify that the vessel's registration or USCG documentation is current and accessible.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Confirm membership details for SeaTow, BoatUS, or similar towing services.",
	...
	Engine: [
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"With the engine running, verify that cooling water is being expelled from the exhaust port.",
			explanation_returning: "N/A",
		},
		{
			id: "fuel",
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the fuel gauge and visually inspect the tank if possible. Ensure sufficient fuel for the trip.",
			explanation_returning:
				"Note the fuel level upon return. Refuel if required by charter agreement.",
		},
		{
			id: "belts",
			label: "Belts",
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the tension and condition of the alternator and water pump belts.",
			explanation_returning: "N/A",
		},
		{
			id: "coolant",
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the engine coolant level in the expansion tank. ONLY CHECK WHEN ENGINE IS COLD.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the engine oil level using the dipstick. Ensure it is between the min/max marks.",
			explanation_returning: "N/A",
		},
	],
	Safety: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Locate the first aid kit and ensure it is fully stocked and not expired.",
		...
		},
		{
			...
			explanation_departing:
				"Verify the number, location, and charge level (gauge in green) of all fire extinguishers.",
			explanation_returning: "Verify all extinguishers are still in place.",
			picture_reason:
				"Take a photo of the extinguishers so people can quickly find it in an emergency.",
		},
		{
			id: "flares",
			label: "Flares",
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the quantity and expiration dates of all visual distress signals (flares).",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Count all Personal Flotation Devices. Ensure they are the correct size and in good condition.",
			explanation_returning:
				"Stow all PFDs in their designated storage areas. Ensure they are dry.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Ensure the throwable ring buoy is accessible and the line is not tangled.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Verify the Lifesling is mounted correctly and the cover is in good condition.",
	...
	"Lines/Sheets/Fenders": [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Ensure there are enough docklines for the vessel, including spares for heavy weather.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check that fenders are inflated and have appropriate lines for hanging.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check if present and inspect safety jack lines for UV damage or fraying.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Visually inspect shrouds, stays, and turnbuckles for any signs of fatigue or 'meat hooks'.",
			explanation_returning: "N/A",
		},
		{
			id: "life_lines",
	...
	Inventory: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Count all winch handles. Ensure at least one is easily reachable from the cockpit.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Ensure basic tools (wrenches, screwdrivers, pliers) are on board for minor repairs.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check that the boat hook is accessible and functions (telescopes) correctly.",
	...
	Steering: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Turn the wheel from lock to lock to ensure smooth operation of the rudder.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"While teh boat is still secure, test the engine shifter to ensure it engages forward and reverse gears smoothly.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Locate the emergency tiller and ensure you know how to fit it to the rudder post.",
			explanation_returning: "N/A",
	...
	"Water Systems": [
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Lift the float switch in the bilge to ensure the automatic pump activates.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Flush the marine toilets (heads) to ensure they pump and drain correctly.",
	...
	Sails: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Partially unfurl the mainsail to check for tears, battens, or jamming.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Partially unfurl the jib/genoa to inspect the UV cover and overall condition.",
	...
	Anchor: [
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check that the primary bow anchor is secured and the pin is in place.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Verify the secondary or stern anchor is accessible and its rode is clear.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Test the electric or manual windlass to ensure it can deploy and retrieve the anchor.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Note the total length of anchor chain available (often marked with paint or zip ties).",
			explanation_returning: "N/A",
		},
		{
			id: "rope_length",
	...
	"Food Management": [
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Check the stern-mounted grill and ensure the propane/gas supply is secure.",
		...
		},
		{
			...
			allow_multi_photo: false,
			explanation_departing:
				"Ensure the refrigeration system is cooling and the door seals are tight.",
			explanation_returning:
				"Empty the refrigerator and leave the door slightly ajar to prevent mold.",
		},
	],
};
