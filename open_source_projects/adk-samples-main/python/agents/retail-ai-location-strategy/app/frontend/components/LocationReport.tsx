		...
		<div className="bg-white rounded-xl shadow-lg border-l-4 border-green-500 overflow-hidden">
			...
			<div className="p-6">
								...
								<div key={i} className="p-3 bg-orange-50 rounded-lg border border-orange-100">
									...
									<div className="mt-2 p-2 bg-white rounded border border-orange-100">
										<p className="text-xs text-gray-700">
											<span className="font-medium">Mitigation:</span> {c.mitigation_strategy}
										</p>
									</div>
								</div>
							))}
				...
				<div className="mt-6 grid md:grid-cols-2 gap-4">
					<InfoCard icon="👥" label="Target Segment" value={rec.best_customer_segment} />
					<InfoCard icon="🚶" label="Foot Traffic" value={rec.estimated_foot_traffic} />
				</div>
