> ⚠️ **PARTIAL REFERENCE** — ~40% من هذه الوثيقة متقادم:
> - **القسم 2:** OBSOLETE كلياً — نهج per-app CLAUDE.md تم التخلي عنه. الملفات الثلاثة حُذفت.
> - **القسم 4:** OBSOLETE كلياً — المخطط يُظهر 16 hook؛ الواقع: 5 hooks نشطة فقط.
> - **القسم 1:** جزئياً — تقنيات خاطئة (Preact لا Vanilla TS، Next.js 15 لا React+Vite)، مفقود Rules 7 و8.
> - **الأقسام 3، 6، 7:** صحيحة ومفيدة — بروتوكول الجلسة، الطوارئ، قوائم المراجعة.
> المرجع الصحيح للقواعد الحالية: `CLAUDE.md` في جذر المشروع.
